...
**Host specs:** 11th Gen Intel i7-1185G7 @ 3.00GHz | 32GB RAM | dedicated 500GB external SSD for thin-provisioned lab VMs
...
| SOAR (Shuffle) | ✅ Step 3.9 validated — automatic marker response, positive/negative filtering, manual reversal, and reboot execution |
...
| ↳ [Shuffle Deployment and Response Validation](build-shuffle.md) | Deployment, Wazuh webhook, filtering, API permissions, endpoint response, and manual reversal |
...
| ↳ [Integration and Validation](integration-validation.md) | As-built record of Steps 3.6–3.9: what was configured, what evidence proved it, what's open |
