...
**VM name:** `SOC-SIEM-ELK` · **Zone:** Management · **IP:** `10.10.10.10` · **Specs:** 8GB RAM / 4 vCPU / 100GB disk (current operator-reported allocation)
...
4. Edit VM settings: **Memory → 8192 MB**, **Processors → 4**, **Network Adapter → Custom: VMnet1 (Management)**.
